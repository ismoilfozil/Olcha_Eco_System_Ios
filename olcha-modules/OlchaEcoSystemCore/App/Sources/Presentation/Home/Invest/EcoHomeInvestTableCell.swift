...
public class EcoHomeInvestTableCell: BaseTableCell {
    ...
    public override func configureViews() {
        ...
        collectionFlowDelegate.module = .invest
        container.round(24)
        layer.zPosition = 1
        clipsToBounds = false
    ...
    public func setup(with model: BuilderSection) {
        ...
        headerView.setSectionLabel(model.section_name ?? "", image: .investAppIcon)
