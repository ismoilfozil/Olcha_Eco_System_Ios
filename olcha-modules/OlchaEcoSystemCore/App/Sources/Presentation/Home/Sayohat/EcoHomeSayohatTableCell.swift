...
public class EcoHomeSayohatTableCell: BaseTableCell {
    ...
    private var model: BuilderSection?
    ...
    public override func configureViews() {
        ...
        headerView.setAllButton {
            ModuleGeneratorHelper.shared.generate(module: .sayohat, appStarted: nil)
        }
    }
    
    public func setup(with model: BuilderSection) {
        self.model = model
        headerView.setSectionLabel(model.section_name ?? "", image: .olchaSayohatSection)
