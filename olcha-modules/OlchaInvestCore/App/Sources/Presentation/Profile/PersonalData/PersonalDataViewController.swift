...
import OlchaUI
import OlchaAuth
public class PersonalDataViewController: BaseViewController<BackNavigationBar> {
    ...
    public override func setupObservers() {
        ...
        handle(viewModel.$editUser, showLoader: true, loading: { [weak self] isLoading in
            guard let self = self else { return }
            saveButton.requesting = isLoading
        })
