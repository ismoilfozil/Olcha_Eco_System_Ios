...
//import OlchaAuth
//
//public class InvestProfileViewModel: BaseViewModel {
//    
//    private let loadProfileUseCase: LoadProfileProtocol
//    private let editProfileUseCase: EditProfileProtocol
//    
//    @Published public var user: LoadingState<InvestUser, BaseErrorType> = .standart
...
//    }
//    
//    public func editUser(_ user: InvestUser?) {
...
//            switch baseResponse.status {
//            case .success:
//                user = .success(baseResponse.response?.data)
//                break
//            default:
