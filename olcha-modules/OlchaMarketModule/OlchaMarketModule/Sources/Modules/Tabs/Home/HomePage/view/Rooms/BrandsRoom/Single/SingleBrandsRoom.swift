...
import Combine
import OlchaUI
class SingleBrandsRoom: BaseTableCell {
    ...
    override func setupViews() {
        ...
        container.addSubview(roomTitleContainer)
        roomTitleContainer.addSubview(roomTitle)
        roomTitleContainer.addSubview(seeAllButton)
    ...
    override func configureViews() {
        ...
        let layout = manager.getLayout(with: .brands(1))
...
extension SingleBrandsRoom: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
