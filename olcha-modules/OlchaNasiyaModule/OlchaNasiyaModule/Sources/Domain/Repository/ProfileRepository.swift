...
public protocol ProfileRepositoryProtocol {
    func loadUser() -> AnyPublisher<BaseResponse<NasiyaUserData, EmptyData>, Never>
    func editUser(user: NasiyaUser) -> AnyPublisher<BaseResponse<EmptyData, EmptyData>, Never>
}
...
public class ProfileRepository: BaseRepository, ProfileRepositoryProtocol {
    ...
    public func editUser(user: NasiyaUser) -> AnyPublisher<BaseResponse<EmptyData, EmptyData>, Never> {
        let api: ProfileAPI = .editUser(model: user)
        return manager.request(api: api)
    }
}

//public class ProfileMockRepository: ProfileRepositoryProtocol {
//    public func loadUser() -> AnyPublisher<BaseResponse<NasiyaUserData, EmptyData>, Never> {
