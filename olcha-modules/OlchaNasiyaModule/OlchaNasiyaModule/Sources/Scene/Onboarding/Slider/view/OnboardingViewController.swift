...
//        collection.backgroundColor = .lightGrayBackground
...
//    }()
//
//    private let registerButton: NasiyaButton = {
//        let button = NasiyaButton()
//        button.setTitle("signin".localized())
...
//        didSet {
//            titleLabel.text = "onboarding_title_\(currentPage + 1)".localized(.olchaNasiyaModule)
//            subtitleLabel.text = "onboarding_subtitle_\(currentPage + 1)".localized(.olchaNasiyaModule)
//
//            leftButton.isHidden = (currentPage == 0)
//            rightButton.isHidden = isLastPage
...
//        }
//
//        registerButton.clicked { [weak self] in
//            guard let self = self else { return }
//            coordinator?.finishOnboarding()
//        }
//    }
