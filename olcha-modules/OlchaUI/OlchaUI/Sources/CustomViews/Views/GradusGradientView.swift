...
import UIKit
public class GradusGradientView: UIView {
    ...
    @IBInspectable
    public var colorRatio: Float = 0.5 {
        didSet {
    ...
    @IBInspectable
    public var fadeIntensity: Float = 0.0 {
        didSet {
    ...
    public var blurOpacity: Float = 0.0 {
        didSet {
