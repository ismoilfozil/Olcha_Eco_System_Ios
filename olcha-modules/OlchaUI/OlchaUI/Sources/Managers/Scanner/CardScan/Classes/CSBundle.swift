...
public class CSBundle {
    ...
    nonisolated(unsafe) public static var bundleName = "CardScan"
    nonisolated(unsafe) public static var extensionName = "bundle"
    nonisolated(unsafe) public static var cardScanBundle: Bundle?
