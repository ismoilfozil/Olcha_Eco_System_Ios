...
struct OcrPriorsGen{
    ...
    */
    ...
    static func genPriors(featureMapSizeHeight: Int, featureMapSizeWidth: Int, shrinkageHeight: Int,
        ...
        var boxes = [CGRect]()
        var xCenter: Float; var yCenter: Float
        var size: Float
        var ratioOne: Float
        ...
        for j in 0..<featureMapSizeHeight{
            for i in 0..<featureMapSizeWidth{
                ...
                boxes.append(CGRect(x: CGFloat(xCenter), y: CGFloat(yCenter), width: CGFloat(w), height: CGFloat(h)))
                ...
                boxes.append(CGRect(x: CGFloat(xCenter), y: CGFloat(yCenter), width: CGFloat(w), height: CGFloat(h * ratioOne)))
                ...
                boxes.append(CGRect(x: CGFloat(xCenter), y: CGFloat(yCenter),
                                    width: CGFloat((w).clamp()), height: CGFloat((h * ratioOne).clamp())))
