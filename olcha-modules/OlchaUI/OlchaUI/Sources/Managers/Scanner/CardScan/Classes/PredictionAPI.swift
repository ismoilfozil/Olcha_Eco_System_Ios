...
struct PredictionAPI{
     ...
     * an object.
     */
    func predictionAPI(scores: [[Float]], boxes: [[Float]], probThreshold: Float, iouThreshold: Float, candidateSize: Int , topK: Int) -> CardScanResult {
        ...
        var result: CardScanResult = CardScanResult()
