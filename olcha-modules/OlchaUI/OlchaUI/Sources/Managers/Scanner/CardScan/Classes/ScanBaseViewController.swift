...
open class KapViewController : UIViewController {
    func updateLanguage() {
...
@objc open class ScanBaseViewController: KapViewController, @preconcurrency AVCaptureVideoDataOutputSampleBufferDelegate, AfterPermissions, OcrMainLoopDelegate {
    ...
    private weak var blurView: ScanBlurView?
    ...
    public func cancelScan() {
        ...
        CardScanApi.scanStats(scanStats: ocrMainLoop.scanStats, completion: {_, _ in })
    }
    ...
    public func setupOnViewDidLoad(regionOfInterestLabel: UIView, blurView: ScanBlurView, previewView: PreviewView, cornerView: CornerView?, debugImageView: UIImageView?, torchLevel: Float?) {
    ...
    public func complete(creditCardOcrResult: CreditCardOcrResult) {
        ...
        // fire and forget
        CardScanApi.scanStats(scanStats: self.getScanStats(), completion: {_, _ in })
