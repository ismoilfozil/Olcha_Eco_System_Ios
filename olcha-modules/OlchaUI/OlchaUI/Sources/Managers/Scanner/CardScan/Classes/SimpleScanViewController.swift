...
open class SimpleScanViewController: ScanBaseViewController  {
    ...
    public var blurView: ScanBlurView = ScanBlurView()
    ...
    // String
    public var descriptionString = "Scan Card".localized()
    public var enableCameraPermissionString = "Enable camera access".localized()
    public var enableCameraPermissionsDescriptionString = "To scan your card you'll need to update your phone settings".localized()
    public var closeButtonString = "Close".localized()
    public var torchButtonString = "Torch".localized()
