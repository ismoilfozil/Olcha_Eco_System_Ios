...
public struct SsdDetect {
    nonisolated(unsafe) static var ssdModel: SSD? = nil
    nonisolated(unsafe) static var priors:[CGRect]? = nil
    ...
    */
    ...
    func detectObjects(prediction: SSDOutput, image: UIImage) -> DetectedAllBoxes {
        ...
        let result:CardScanResult = predAPI.predictionAPI(scores:normalizedScores, boxes: cornerFormBoxes, probThreshold: SsdDetect.probThreshold, iouThreshold: SsdDetect.iouThreshold, candidateSize: SsdDetect.candidateSize, topK: SsdDetect.topK)
