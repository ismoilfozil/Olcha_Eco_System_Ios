...
public class CardScanner: UIViewController {
    ...
    public var hintTopText = "scan_title".localized()
    public var hintBottomText = "scan_subtitle".localized()
    public var buttonConfirmTitle = "confirm".localized()
    public var buttonConfirmBackgroundColor: UIColor = .olchaAccentColor
    public var viewTitle = "scan".localized()
    ...
    override public func viewDidLoad() {
        ...
        buttomItem.tintColor = .olchaWhite
        navigationItem.rightBarButtonItem = buttomItem

//         = UIBarButtonItem(image: ,
//                                             target: self,
//                                             action: #selector(changeFlashlight))
        let leftButtomItem = UIBarButtonItem(image: UIImage(systemName: "flashlight.on.fill"),
                                             style: .plain,
                                             target: self,
                                             action: #selector(changeFlashlight))
        leftButtomItem.tintColor = .olchaWhite
        navigationItem.leftBarButtonItem = leftButtomItem
    }
...
extension CardScanner: @preconcurrency AVCaptureVideoDataOutputSampleBufferDelegate {
