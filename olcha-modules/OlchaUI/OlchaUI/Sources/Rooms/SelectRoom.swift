...
import UIKit
import OlchaUtils
public class SelectRoom: BaseTableCell {
    ...
    public func setup(key: String, value: String) {
        titleLabel.text = value
        
        radioIcon.image = (String.getAppLanguage() == key) ? .round_selected_check : .round_unselected_check
    }
